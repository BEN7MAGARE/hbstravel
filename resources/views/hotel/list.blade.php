                ...
                <div class="col-lg-8 col-xs-12 mb-4">
                    <div class="trend-box">
                        ...
                        {{-- <div class="text-right">
                            <a href="{{ $hotels->previousPageUrl() }}" class="btn bg-white">
                                Prev
                            </a>
                            @for ($i = 0; $i <= $hotels->lastPage(); $i++)
                                <a href="{{ $hotels->url($i) }}" class="btn bg-white">{{ $i }}</a>
                            @endfor
                            <a href="{{ $hotels->nextPageUrl() }}" class="btn bg-white">
                                Next
                            </a>
                        </div> --}}
                    </div>
