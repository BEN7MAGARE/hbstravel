                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-4">
                        <div class="footer-about bg-white p-4">
                            ...
                            <ul>
                                <li><strong>PO Box:</strong> +9715</li>
                                <li><strong>Location:</strong> Dubai - UAE</li>
                                <li><strong>Email:</strong> info@hbstravel.ae</li>
                                <li><strong>Website:</strong> www.hbstravel.ae</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="copyright-inner d-md-flex align-items-center justify-content-between">
                    <div class="copyright-text">
                        <p class="m-0 white">2022 HBS TRAVEL. All rights reserved. Designed by <a href="https://letsmovetech.com">Lets Move Technology</a></p>
                    </div>
