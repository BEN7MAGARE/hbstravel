...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $payment = $this->payment->create([
            ...
            'AddressLine1' => $request["CardHolderAddress"]["AddressLine1"],
            'AddressLine2' => $request["CardHolderAddress"]["AddressLine2"],
            'City' => $request["CardHolderAddress"]["City"],
            'PostalCode' => $request["CardHolderAddress"]["PostalCode"],
            'CountryCode' => $request["CardHolderAddress"]["CountryCode"],
